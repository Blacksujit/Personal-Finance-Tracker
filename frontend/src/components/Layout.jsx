...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-72 bg-white/90 backdrop-blur-xl border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0
        ...
        <div className="flex flex-col h-full">
              ...
              return (
                ...
                >
                  <div className={`
                    ...
                    ${active ? 'bg-white/20 text-white' : 'text-gray-400 group-hover:text-gray-600'}
                  `}>
                    {item.icon}
                  </div>
                  {item.name}
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            <div className="px-4 py-3 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl">
              ...
              <div className="text-xs text-gray-500 mt-1">Great job this month!</div>
            </div>
          </div>
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            ...
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-lg mr-3 text-red-400 group-hover:text-red-600">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
